        ...
        <div className="about-content">
          <div className="about-text">
            <p className="about-paragraph about-intro">
              I've already built applications serving thousands of users. While others my age are still learning syntax, I'm shipping production code.
            </p>
            ...
            <div className="about-highlights">
              ...
              <ul className="about-list">
                ...
                <li><strong>Decap-sdk</strong> — A free captcha package for Web3 apps.(700+ downloads)</li>
                <li><strong>Docspice</strong> — AI-powered article generator (1,000+ articles processed)</li><li><strong>Reactive News</strong> — Real-time crypto news platform (500+ daily users)</li>
              </ul>
            </div>
