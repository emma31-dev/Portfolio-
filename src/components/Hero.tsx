      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Building production-ready Web3 applications that drive real user engagement. 4+ live dApps serving 2000+ active users.
          </p>
          <div className="hero-buttons">
            <div className="hero-social-links">
              ...
              <a href="https://x.com/emmafidel31" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
